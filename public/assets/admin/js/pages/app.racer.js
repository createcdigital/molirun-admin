        ...
        handleActionEditDatatable: function () {
            ...
            $('#modal-edit-datatable').on('show.bs.modal', function (e){
                ...
                var family_html = '' +
                    ...
                    '<input id="radio_p1_sex_male" checked="checked" type="radio" value="男" name="radio_p2_sex">' +
                    '<label for="radio_p1_sex_male">男</label>' +
                    '</div>' +
                    '</div>' +
                    '<div class="col-sm-4">' +
                    '<div class="rdio rdio-theme circle">' +
                    '<input id="radio_p1_sex_female" type="radio" value="女" name="radio_p2_sex">' +
                    ...
                    '<div class="col-sm-4">' +
                    '<div class="rdio rdio-theme circle">' +
                    '<input id="radio_p1_sex_male" checked="checked" type="radio" value="男" name="radio_kids_sex">' +
                    '<label for="radio_p1_sex_male">男</label>' +
                    '</div>' +
                    '</div>' +
                    '<div class="col-sm-4">' +
                    '<div class="rdio rdio-theme circle">' +
                    '<input id="radio_p1_sex_female" type="radio" value="女" name="radio_kids_sex">' +
                    '<label for="radio_p1_sex_female">女</label>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
