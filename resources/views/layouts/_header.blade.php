    ...
    <div class="header-left">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('dashboard/index')}}">
                {{--<img class="logo" src="{{ asset('assets/admin/img/logo/html/logo-149x45-white.png') }}" alt="brand logo"/>--}}
            </a><!-- /.navbar-brand -->
            <!--/ End brand -->
            ...
            <ul class="nav navbar-nav navbar-right"><!-- /.nav navbar-nav navbar-right -->
                ...
                <li class="dropdown navbar-profile">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="meta">
                            <span class="avatar"><img src="{{ asset('assets/admin/img/avatar/35/1.png') }}" class="img-circle" alt="admin"></span>
                            <span class="text hidden-xs hidden-sm text-muted">{{ $user->name }}</span>
                    ...
                    <ul class="dropdown-menu animated flipInX">
                        ...
                        <li><a href="{{url('page/signout')}}"><i class="fa fa-sign-out"></i>Logout</a></li>
                    </ul>
                    <!--/ End dropdown menu -->
