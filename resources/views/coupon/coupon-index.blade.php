    ...
    <div class="header-content">
        ...
        <div class="breadcrumb-wrapper hidden-xs">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="/coupon/index">{{ trans('coupon.code') }} {{ trans('layout.management') }}</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li class="active">{{ trans('coupon.information') }}</li>
            </ol>
            ...
            <div class="col-md-12">
                ...
                <div class="panel rounded shadow no-overflow">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h3 class="panel-title">{{ trans('coupon.list') }}</h3>
                        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered" id="datatable-sample">
                            ...
                            <tr>
                                ...
                                <th>{{ trans('coupon.number_of_use') }}</th>
                            </tr>
                            </thead>
...
@section('js-page')
    ...
    <script src="{{ asset('assets/admin/js/pages/app.coupon.js') }}"></script>
