...
class PageController extends BaseController {
    ...
    public function gallery() {
        ...
        View::share('title', 'GALLERY | SHAKE TO WIN');
    ...
    public function faq() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'FAQ | SHAKE TO WIN');
    ...
    public function calendar() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'CALENDAR | SHAKE TO WIN');
    ...
    public function invoice() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'INVOICE | SHAKE TO WIN');
    ...
    public function messages() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'MESSAGES | SHAKE TO WIN');
    ...
    public function timeline() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'TIMELINES | SHAKE TO WIN');
    ...
    public function profile() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'PROFILE | SHAKE TO WIN');
    ...
    public function searchCourse() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'SEARCH COURSE | SHAKE TO WIN');
    ...
    public function error403() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'ERROR 403 | SHAKE TO WIN');
    ...
    public function error404() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'ERROR 404 | SHAKE TO WIN');
    ...
    public function error500() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'ERROR 500 | SHAKE TO WIN');
    ...
    public function signinType2() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'SIGN IN TYPE 2 | SHAKE TO WIN');
    ...
    public function lockScreen() {
        ...
        View::share('css', $this->css);
        View::share('js', $this->js);
        View::share('title', 'LOCK SCREEN | SHAKE TO WIN');
